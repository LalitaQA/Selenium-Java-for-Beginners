...
//4.Select All the Months (you can use any select method)
//5.Deselect the Feb, May, July, Nov (Using deselect method of Value deselectByValue)
...
public class D_02_DeSelectByValue {
